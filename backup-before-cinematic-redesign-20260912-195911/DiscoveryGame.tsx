...
import { StoryVoice } from "@/components/audio/StoryVoice";
      ...
      <div className="ru-new-content">
        ...
        {phase === "story" && story && (
          <section className="ru-story-scene">
            <div className="ru-story-scene-glow" />

            <div className="ru-story-shell">
              <aside className="ru-story-character-stage">
                <div className="ru-character-orbit" />

                <div className="ru-character-frame">
                  <img
                    src={selectedCharacter.src}
                    alt=""
                  />
                ...
                <div className="ru-character-name">
                  THE WATCHER
                </div>

                <div className="ru-character-status">
                  <span />
                  CONNECTED TO REALITY
                </div>
              </aside>

              <main className="ru-story-main">
                <div className="ru-story-header">
                  <div>
                    <span className="ru-new-eyebrow">
                      REALITY UNKNOWN / DISCOVERY
                    </span>

                    <div className="ru-story-meta">
                      <span>
                        DISCOVERY{" "}
                        {String(
                          discoveryCount,
                  ...
                  <div className="ru-story-confidence">
                    <span>
                      VISION CONFIDENCE
                    </span>
                ...
                <h1 className="ru-story-title">
                  {story.discoveryTitle ||
                    story.subject ||
                    "A discovery worth remembering"}
                </h1>

                <p className="ru-story-subject">
                  {story.subject ||
                    "The camera has identified something worth investigating."}
                </p>

                <div className="ru-watcher-message">
                  <div className="ru-watcher-mark">
                    ◇
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      {story.characterOpening ||
                        `I think we have found something interesting, ${playerName}.`}
                    </p>
                  </div>
                </div>
                ...
                {(() => {
                      ...
                      : [
                          {
                            ...
                            text:
                              ...
                              "The camera has found something worth investigating.",
                            voiceText:
                              story.historicalStory ||
                              "",
                          },
                  ...
                  const isLast =
                    safeIndex >= beats.length - 1;

                  return (
                    <article className="ru-story-card">
                      <div className="ru-story-card-top">
                        ...
                        <span className="ru-story-step">
                          0{safeIndex + 1} / 0
                          {beats.length}
                        </span>
                      </div>

                      <span className="ru-story-kicker">
                        {beat.title}
                      </span>

                      <p className="ru-story-beat">
                        {beat.text}
                      </p>

                      <div className="ru-story-card-footer">
                        <StoryVoice
                          text={
                            beat.voiceText ||
                            beat.text
                        ...
                        <button
                          type="button"
                          className="ru-story-next"
                          onClick={() => {
                            if (isLast) {
                              setShowStoryQuestion(
                                true,
                              );
                              setStoryAnswer(null);
                            } else {
                ...
                {showStoryQuestion && (
                  <section className="ru-story-question-card">
                    <span className="ru-story-kicker">
                      THE WATCHER / REMEMBER
                    </span>
                    ...
                    <StoryVoice
                      text={[
                        story.storyQuestion ||
                          `What did you learn about this discovery, ${playerName}?`,
                        ...(story.storyQuestionOptions ?? []).map(
                          (option, index) =>
                    ...
                    <div className="ru-story-options">
                      {(
                        ...
                        [
                          ...
                          "The camera could not establish it",
                        ]
                      ).map((option, index) => {
                        const answered =
                          storyAnswer !== null;
                    ...
                    {storyAnswer !== null && (
                      <div
                        className={
                          storyAnswer ===
                          story.storyQuestionAnswer
                            ? "ru-story-result correct"
                            : "ru-story-result incorrect"
                        }
                      >
                        <div className="ru-story-result-character">
                          <img
                            src={
                        ...
                        <div>
                          ...
                          <p>
                            {story.storyQuestionExplanation ||
                              "The answer is grounded in what the story established about this discovery."}
                          </p>
                        </div>
                      </div>
                    )}
                ...
                {storyAnswer !== null && (
                  <section className="ru-next-move">
                    <span className="ru-story-kicker">
                    ...
                    <div className="ru-next-grid">
                      ...
                      >
                        ...
                        <small>
                          Inspect reality again
                        </small>
                      </button>
                    </div>

                    {showCuriosity && (
                      <div className="ru-curiosity-panel">
                        <div className="ru-curiosity-header">
                          <span>
                            ASK THE WATCHER
                          </span>

                          <small>
                            QUESTIONS ABOUT THIS DISCOVERY
                          </small>
                        </div>
                        ...
                        <div className="ru-curiosity-list">
                          {(
                            ...
                            [
                              `What makes ${story.subject || "this place"} interesting?`,
                              "What should I notice when I look again?",
                        ...
                        {curiosityAnswer && (
                          <div className="ru-curiosity-answer">
                            <span>
                              THE WATCHER
                            </span>
                            ...
                            <p>
                              {story.historicalDetails?.[
                                Math.max(
                                  0,
                                  story.curiosityQuestions?.indexOf(
                                    curiosityAnswer,
                                  ) ?? 0,
                                )
                              ] ||
                                story.historicalStory ||
                                "The photograph gives us a starting point. Look closely at the details around you."}
                            </p>
                          </div>
                        )}
                      </div>
